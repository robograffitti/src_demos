...
def walkTest():
    ...
    msg.transfer_time = 0.125 # 1.5
    msg.swing_time = 0.400
    msg.execution_mode = 0 # 1 or 3 ?
    msg.unique_id = -1

    msg.footstep_data_list.append(createFootStepOffset(RIGHT, [0.40, -0.02, 0.0]))
    msg.footstep_data_list.append(createFootStepOffset(LEFT, [0.80, 0.02, 0.0]))
    msg.footstep_data_list.append(createFootStepOffset(RIGHT, [1.20, -0.04, 0.0]))
    msg.footstep_data_list.append(createFootStepOffset(LEFT, [1.60, 0.04, 0.0]))
    msg.footstep_data_list.append(createFootStepOffset(RIGHT, [2.00, -0.06, 0.0]))
    msg.footstep_data_list.append(createFootStepOffset(LEFT, [2.40, 0.06, 0.0]))
    msg.footstep_data_list.append(createFootStepOffset(RIGHT, [2.80, 0.0, 0.0]))
    msg.footstep_data_list.append(createFootStepOffset(LEFT, [2.80, 0.0, 0.0]))
