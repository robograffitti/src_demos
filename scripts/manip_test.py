...
# LIFT_ARM = [-0.250, 1.000, 0.200, 1.0, 0.0, 0.0, 0.0]
# PUSH_BUTTON = [-1.00, 0.750, 0.500, 0.150, 0.0, 0.0, 0.0] # push_button 1
PUSH_BUTTON = [-1.000, 0.400, 0.30, 0.95, 0.0, 0.0, 0.0] # push_button 1
LIFT_ARM = [-0.500, 0.400, 0.0, 1.5, 0.0, 0.0, 0.0]
TUCK_ARM = [-0.500, 1.25, 0.0, 1.5, 0.0, 0.0, 0.0]
...
def sendRightArmTrajectory():
    ...
    msg = appendTrajectoryPoint(msg, 0.25, LIFT_ARM)
    msg = appendTrajectoryPoint(msg, 0.50, PUSH_BUTTON)
    msg = appendTrajectoryPoint(msg, 1.00, TUCK_ARM)
